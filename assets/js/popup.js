...
const popup = {
    ...
    popup_block_scroll_fix: function () {
        ...
        if (!isMacLike) {
            ...
            block.find(".content_wrap_inner").css("overflow-y", 'auto');
        }
        // block.find(".content_wrap_inner").scrollbar();
    },
